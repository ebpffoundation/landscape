...
export function Footer({ className = '' }: FooterProps) {
  return (
    <footer
      {...getTestId('footer')}
      className={`bg-stone-900 border-t border-stone-800 ${className}`}
      role="contentinfo"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <NavigationLink href="/" footer>
                  Home
                </NavigationLink>
              </li>
              <li>
                <NavigationLink href="/contribute" footer>
                  Contribute
                </NavigationLink>
              </li>
            </ul>
        ...
        <div className="mt-8 pt-8 border-t border-dashed border-stone-800">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-stone-400 text-sm">
              © {new Date().getFullYear()} eBPF Community. All rights reserved.
            </div>
            <div className="flex space-x-6 mt-4 md:mt-0">
              ...
              <a
                href="https://twitter.com/eBPFsummit"
                target="_blank"
                rel="noopener noreferrer"
                className="text-stone-400 hover:text-white transition-colors"
                aria-label="Twitter"
